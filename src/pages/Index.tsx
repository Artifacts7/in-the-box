  ...
  return (
    <div className="min-h-screen flex flex-col bg-white text-black">
      ...
      <main className="flex-1 flex flex-col md:flex-row relative">
        ...
        <div className="md:hidden py-3 px-4 bg-purple-50">
          <button 
        ...
        {sidebarOpen && (
          <div 
            ref={sidebarRef}
            className="absolute top-full left-0 right-0 z-20 bg-white border-b border-purple-100 shadow-lg md:hidden animate-fade-in"
          >
