...
const Index = () => {
  ...
  return <div className="min-h-screen flex flex-col bg-white text-black">
      ...
      <main className="flex-1 flex flex-col md:flex-row relative">
        ...
        <div ref={sidebarRef} className={`md:static fixed inset-y-0 left-0 z-20 transform transition-transform duration-300 ease-in-out md:translate-x-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
