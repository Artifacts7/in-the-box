...
const CategorySidebar = ({
  ...
  return <div 
    ...
    className="w-full md:w-72 bg-white h-auto md:h-full overflow-y-auto border-b md:border-b-0 border-gray-200 transition-all duration-300 ease-in-out animate-fade-in py-4"
  >
      <div className="space-y-2 px-4 pt-2">
        {allCategories.map(category => 
          <button 
            ...
            className={`sidebar-category w-full flex items-center justify-between p-3 transition-all duration-200 ${selectedCategory === category.id ? "sidebar-category-selected" : "sidebar-category-normal"}`} 
            style={{
              fontFamily: "'VT323', monospace"
            }}
          >
